      ...
      <!-- Page Container -->
        <div class="page-container">
            ...
            <div class="page-sidebar">
                <a class="logo-box" href="{{route('dashboard')}}"><img src="/assets/images/bee.png" alt="" class="img-circle" style="max-width: 60%"></a>
                    ...
                    <div class="page-sidebar-menu">
                        <ul class="accordion-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li><a href="{{route('mymasternodes')}}">My Masternodes</a></li>
                                    <li><a href="{{route('masternodes')}}">All Masternodes </a></li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="{{auth()->user()->avatar}}" alt="" class="img-circle"></a>
