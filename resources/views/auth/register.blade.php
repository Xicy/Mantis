                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="m-t-md" method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder='Name' name="name" required>
                                            @error('name')
                                        ...
                                        <label>
                                            <input type="checkbox">Agree the terms and privacy
                                        </label>
                                            <button type="submit" class="btn btn-success btn-block badge-submit-reg-button">Submit</button>
